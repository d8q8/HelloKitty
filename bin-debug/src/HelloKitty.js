...
var HelloKitty = (function (_super) {
    ...
    HelloKitty.prototype.init = function () {
        var _this = this;
        //心形状
        var line = new lcp.LCircle({ x: 100, y: 200, radius: 50, fillcolor: 0xff0000, thickness: 10, linecolor: 0x00ff00 });
        this.addChild(line);
        // 画圆角
        ...
        //});
        var tweenlite1 = TweenLite.to(sp, 1, { x: 100, y: 500, scaleX: .5, scaleY: .5, rotation: 360, onComplete: function (e) {
